...
export const categories: Category[] = [
  { title: 'Bánh mì', count: '342 địa điểm', icon: createElement(Sandwich, { className: "h-6 w-6 text-orange-500" }), bg: 'bg-[#fff7ed]' },
  { title: 'Phở', count: '218 địa điểm', icon: createElement(Soup, { className: "h-6 w-6 text-blue-500" }), bg: 'bg-[#eff6ff]' },
  { title: 'Bún', count: '189 địa điểm', icon: createElement(UtensilsCrossed, { className: "h-6 w-6 text-green-500" }), bg: 'bg-[#f0fdf4]' },
  { title: 'Cơm', count: '276 địa điểm', icon: createElement(Utensils, { className: "h-6 w-6 text-fuchsia-500" }), bg: 'bg-[#fdf4ff]' },
  { title: 'Hải sản', count: '157 địa điểm', icon: createElement(Fish, { className: "h-6 w-6 text-cyan-500" }), bg: 'bg-[#ecfeff]' },
  { title: 'Đồ ngọt', count: '203 địa điểm', icon: createElement(CakeSlice, { className: "h-6 w-6 text-rose-500" }), bg: 'bg-[#fff1f2]' },
  { title: 'Cà phê', count: '421 địa điểm', icon: createElement(Coffee, { className: "h-6 w-6 text-yellow-600" }), bg: 'bg-[#fefce8]' },
];
