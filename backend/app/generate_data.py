...
CITIES = [
    {"ten": "Hà Nội", "lat_min": 20.97, "lat_max": 21.13, "lng_min": 105.76, "lng_max": 105.92, "districts": ["Hoàn Kiếm", "Ba Đình", "Đống Đa", "Hai Bà Trưng", "Cầu Giấy", "Thanh Xuân", "Hoàng Mai", "Long Biên", "Tây Hồ", "Nam Từ Liêm", "Bắc Từ Liêm", "Hà Đông"]},
    {"ten": "TP.HCM", "lat_min": 10.72, "lat_max": 10.85, "lng_min": 106.62, "lng_max": 106.78, "districts": ["Quận 1", "Quận 3", "Quận 5", "Quận 7", "Quận 10", "Tân Bình", "Bình Thạnh", "Phú Nhuận", "Gò Vấp", "Thủ Đức"]},
    {"ten": "Đà Nẵng", "lat_min": 16.02, "lat_max": 16.10, "lng_min": 108.18, "lng_max": 108.27, "districts": ["Hải Châu", "Thanh Khê", "Sơn Trà", "Ngũ Hành Sơn", "Liên Chiểu", "Cẩm Lệ"]},
    {"ten": "Hải Phòng", "lat_min": 20.82, "lat_max": 20.88, "lng_min": 106.65, "lng_max": 106.73, "districts": ["Hồng Bàng", "Lê Chân", "Ngô Quyền", "Kiến An", "Hải An", "Đồ Sơn", "Dương Kinh"]},
    {"ten": "Cần Thơ", "lat_min": 10.00, "lat_max": 10.08, "lng_min": 105.72, "lng_max": 105.82, "districts": ["Ninh Kiều", "Bình Thủy", "Cái Răng", "Ô Môn", "Thốt Nốt"]},
    {"ten": "Huế", "lat_min": 16.42, "lat_max": 16.50, "lng_min": 107.54, "lng_max": 107.64, "districts": ["Thuận Hóa", "Phú Xuân", "Hương Thủy", "Hương Trà"]},
    {"ten": "Đà Lạt", "lat_min": 11.92, "lat_max": 11.98, "lng_min": 108.40, "lng_max": 108.48, "districts": ["Phường 1", "Phường 2", "Phường 3", "Phường 4", "Phường 5", "Phường 6", "Phường 7", "Phường 8"]},
    {"ten": "Nha Trang", "lat_min": 12.22, "lat_max": 12.28, "lng_min": 109.17, "lng_max": 109.23, "districts": ["Vĩnh Hải", "Vĩnh Nguyên", "Vĩnh Thọ", "Xương Huân", "Vạn Thạnh", "Phước Hải", "Phước Hòa", "Lộc Thọ"]},
    {"ten": "Vũng Tàu", "lat_min": 10.33, "lat_max": 10.40, "lng_min": 107.05, "lng_max": 107.12, "districts": ["Phường 1", "Phường 2", "Phường 3", "Phường 4", "Phường 5", "Phường 7", "Phường 8", "Phường 9"]},
    {"ten": "Hạ Long", "lat_min": 20.93, "lat_max": 21.00, "lng_min": 107.05, "lng_max": 107.15, "districts": ["Hồng Gai", "Bãi Cháy", "Hà Khánh", "Hà Trung", "Hà Phong", "Hà Lầm", "Hà Khẩu"]},
    {"ten": "Biên Hòa", "lat_min": 10.92, "lat_max": 10.98, "lng_min": 106.78, "lng_max": 106.86, "districts": ["Trảng Dài", "Tân Phong", "Tân Mai", "Tam Hiệp", "Long Bình", "Hố Nai", "An Bình"]},
    {"ten": "Hội An", "lat_min": 15.86, "lat_max": 15.92, "lng_min": 108.30, "lng_max": 108.38, "districts": ["Minh An", "Tân An", "Cẩm Phô", "Cẩm Nam", "Cẩm Châu", "Sơn Phong"]},
    {"ten": "Vinh", "lat_min": 18.66, "lat_max": 18.72, "lng_min": 105.64, "lng_max": 105.72, "districts": ["Hồng Sơn", "Trung Đô", "Hưng Bình", "Hưng Dũng", "Quán Bàu", "Lê Lợi", "Đội Cung"]},
    {"ten": "Quy Nhơn", "lat_min": 13.74, "lat_max": 13.80, "lng_min": 109.19, "lng_max": 109.26, "districts": ["Nhơn Bình", "Nhơn Phú", "Lê Hồng Phong", "Trần Phú", "Hải Cảng", "Nguyễn Văn Cừ"]},
    {"ten": "Buôn Ma Thuột", "lat_min": 12.64, "lat_max": 12.72, "lng_min": 108.02, "lng_max": 108.10, "districts": ["Tự An", "Tân Lập", "Tân Tiến", "Tân Hòa", "Thành Nhất", "Thành Công", "Ea Tam"]},
]
